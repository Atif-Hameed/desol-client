...
const CarForm = () => {
  ...
  return (
    <div className="flex flex-wrap justify-between lg:min-h-screen w-full">
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-12 w-full md:flex block items-center justify-center text-black">
        <Toaster />
        ...
        <h1 className='md:text-4xl text-2xl text-center mb-10 font-semibold' >Fill the deatils</h1>
          ...
          <div className="mb-4">
            <button type="submit" className="w-full py-2 px-4 bg-purple text-white rounded-md shadow-sm hover:bg-blue-700 focus:ring-blue-500">
